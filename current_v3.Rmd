...
dZA <- 0
dZV <- 0
czerozero <- getcmunu(filellist = filelist, mu=0, nu=0, boot.R=bootsamples, ZA=ZA, ZV=ZV, dZA=dZA, dZV=dZV, w2=1, boot.l=bootl)
print(czerozero)
...
y^1 11 +22
```{r}
cthreethree <- getcmunu(filellist = filelist, mu=3, nu=3, boot.R=bootsamples, ZA=ZA, ZV=ZV, dZA=dZA, dZV=dZV, w2=1, boot.l=bootl)
czerothree <- getcmunu(filellist = filelist, mu=0, nu=3, boot.R=bootsamples, ZA=ZA, ZV=ZV, dZA=dZA, dZV=dZV, w2=1, boot.l=bootl, unsymmetric=F)
cthreezero <- getcmunu(filellist = filelist, mu=3, nu=0, boot.R=bootsamples, ZA=ZA, ZV=ZV, dZA=dZA, dZV=dZV, w2=1, boot.l=bootl, unsymmetric=F)
coneone <- getcmunu(filellist = filelist, mu=1, nu=1, boot.R=bootsamples, ZA=ZA, ZV=ZV, dZA=dZA, dZV=dZV, w2=1, boot.l=bootl)
...
ctwotwo <- getcmunu(filellist = filelist, mu=2, nu=2, boot.R=bootsamples, ZA=ZA, ZV=ZV, dZA=dZA, dZV=dZV, w2=1, boot.l=bootl)
```
...
yfour <- multiplycfscalar(czerothree+cthreezero, -0.5)# - cthreezero
...
yfour <- dividebyreal.cf(yfour, denom)
...
# yone <- multiplycfscalar(yone, 0.5) / denom
...
```
```{r}
data_christiane <- data.frame(t=seq(0,127), c4=czerozero$cf0, dc4=czerozero$tsboot.se, c2=scalarsmearedalltimeslices$cf0, dc2=scalarsmearedalltimeslices$tsboot.se, 
ytwo = c(ytwo$cf0[(tins+1):1], rep(NA, 127-tins)), 
dy2=c(ytwo$tsboot.se[(tins+1):1], rep(NA, 127-tins)))
...
# plotwitherror(x=dataantonio$t[1:49], y=(-data_christiane$zzero[1:49]+dataantonio$Z0[1:49]), dy=sqrt(data_christiane$dzzero[1:49]^2+dataantonio$dZ0[1:49]^2), main="Z_0 antonio vs Z_0 christiane", ylim=c(-0.4, 0.7))
# lines(x=seq(-10, 58), y=rep(0, 69))
# plotwitherror(x=dataantonio$t[1:49], y=(-data_christiane$zone[1:49]+dataantonio$Z1[1:49]), dy=sqrt(data_christiane$dzone[1:49]^2+dataantonio$dZ1[1:49]^2), main="Z_1 antonio vs Z_1 christiane", ylim=c(-0.4, 0.9))
# lines(x=seq(-10, 58), y=rep(0, 69))
# plotwitherror(x=dataantonio$t[1:49], y=(-data_christiane$ztwo[1:49]+dataantonio$Z2[1:49]), dy=sqrt(data_christiane$dztwo[1:49]^2+dataantonio$dZ2[1:49]^2), main="Z_2 antonio vs Z_2 christiane", ylim=c(-0.25, 0.25))
# lines(x=seq(-10, 58), y=rep(0, 69))
# plotwitherror(x=dataantonio$t[1:49], y=(-data_christiane$zzero[1:49]+dataantonio$Z0[1:49]), dy=sqrt(data_christiane$dzzero[1:49]^2+dataantonio$dZ0[1:49]^2), main="Z_0 antonio vs Z_0 christiane", ylim=c(-1e-5, 1e-5))
# lines(x=seq(-10, 58), y=rep(0, 69))
# plotwitherror(x=dataantonio$t[1:49], y=(-data_christiane$zone[1:49]+dataantonio$Z1[1:49]), dy=sqrt(data_christiane$dzone[1:49]^2+dataantonio$dZ1[1:49]^2), main="Z_1 antonio vs Z_1 christiane", ylim=c(-1e-5, 1e-5))
# lines(x=seq(-10, 58), y=rep(0, 69))
# plotwitherror(x=dataantonio$t[1:49], y=(-data_christiane$ztwo[1:49]+dataantonio$Z2[1:49]), dy=sqrt(data_christiane$dztwo[1:49]^2+dataantonio$dZ2[1:49]^2), main="Z_2 antonio vs Z_2 christiane", ylim=c(-1e-5, 1e-5))
# lines(x=seq(-10, 58), y=rep(0, 69))
...
write.table(datacorr, "datacorr_t1_16_t2_48.csv", col.names=T, row.names=F)
```
compare masses
```{r, eval=FALSE}
...
lines(x=seq(-10, 58), y=rep(0, 69))
# plotwitherror(x=dataantonio$t[1:49], y=(-data_christiane$ztwo[1:49]+dataantonio$Z2[1:49]), dy=sqrt(data_christiane$dztwo[1:49]^2+dataantonio$dZ2[1:49]^2), main="Z_2 antonio vs Z_2 christiane", ylim=c(-0.25, 0.25), xlab="t", ylab="deviation")
lines(x=seq(-10, 58), y=rep(0, 69))
```
