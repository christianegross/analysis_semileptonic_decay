...
scalarsmearedeffmass <- fit.effectivemass(scalarsmearedeffmass, t1=15, t2=48, useCov=FALSE)
...
scalarsmearedjkeffmass <- fit.effectivemass(scalarsmearedjkeffmass, t1=15, t2=48, useCov=TRUE)
...
plotwitherror(x=data_a_mass$V1, y=abs(data_a_mass$V2-scalarsmearedalltimeslices$cf0), dy=sqrt(data_a_mass$V3^2+scalarsmearedalltimeslices$tsboot.se^2), log="y", main="abs value C_2 antonio vs christiane(from re-symmetrised effective mass fit", ylim=c(1e-38, 1e-14))
